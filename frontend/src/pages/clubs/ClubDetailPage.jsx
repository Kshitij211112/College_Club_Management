...
const ClubDetailPage = () => {
    ...
    const handleJoinRequest = async () => {
        try {
            const res = await clubService.join(id);
    ...
    if (loading) return <Spinner label="Loading Experience" />;
    ...
    const userIsPresident = isPresidentCheck();
        ...
        <div className="min-h-screen bg-[var(--bg-color)] text-[var(--text-color)] selection:bg-blue-500/30 transition-colors duration-300">
            ...
            <nav className="sticky top-0 z-50 bg-[var(--bg-color)]/80 backdrop-blur-md border-b border-slate-700/20">
                <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
                    <button onClick={() => navigate(-1)} className="group flex items-center gap-2 text-slate-400 hover:text-[var(--text-color)] transition-all">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        <header className="space-y-6">
                            ...
                            <div className="h-1.5 w-24 bg-blue-600 rounded-full shadow-lg shadow-blue-600/20" />
                        </header>
                                ...
                                <div className="bg-[var(--card-bg)] rounded-2xl border border-slate-700/20 p-8 space-y-4 transition-all hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/5">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <button onClick={handleManageTeams} className="group flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-all">
                                ...
                                {isMember ? (
                                    <div className="text-center space-y-6">
                                        ...
                                        <div className="space-y-3 pt-2">
                                            <button onClick={handleManageTeams} className="w-full py-4 bg-blue-600/10 border border-blue-500/30 text-blue-400 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-blue-600/20 hover:border-blue-500/50 transition-all active:scale-95 flex items-center justify-center gap-2">
